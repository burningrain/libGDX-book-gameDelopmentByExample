...
/**
 * This file was copied from https://pastebin.com/R0jMh4ui
 *
...
public class JarUtils {
    ...
    private static Array<FileHandle> getFileHandleArrayList(JarFileFilter jarFileFilter) {
        ...
        if (jarFile == null) return new Array<FileHandle>(); // We check even if this should never happen.

        Array<FileHandle> files = new Array<FileHandle>();
        ZipFile zf = null;
        try {
            zf = new ZipFile(jarFile.getAbsoluteFile());
